...
export default async function Page() {
    ...
    return (
        <>
            <header className="pt-[7.563rem] pb-[6.063rem] bg-page-header bg-cover bg-no-repeat bg-center bg- flex justify-center items-center">
                <div>
            ...
            <div className="bg-secondary-bg-color py-8">
                <div className="container 2xl w-full mx-auto flex justify-between">
                    <div className="flex items-center">
                        <ul className="inline-flex items-center space-x-6 pr-8 border-r border-border-color">
